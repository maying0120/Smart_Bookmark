...
void display_char(unsigned char chXpos, unsigned char chYpos, unsigned char chChr, unsigned char chSize, int hwColor)//自左到右参数分别为X,Y,字符，颜色
{      	
	uint8_t i, j, chTemp;
...
else draw_point(chXpos, chYpos, 0x0000);				
			chTemp <<= 1;
			chYpos ++;
...
{         	
	...
	for(t=0;t<len;t++)
	{
		...
		if(enshow==0&&t<(len-1))
		{
			if(temp==0)
			{
				display_char(x+(size/2)*t,y,' ',size,hwColor);
				continue;
			}else enshow=1; 
		 	 
		}
	 	display_char(x+(size/2)*t,y,temp+'0',size,hwColor); 
	}
}
...
void OLED_Init()
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_13;	 //PD3,PD6推挽输出  
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	GPIO_Init(GPIOD, &GPIO_InitStructure);	  //初始化GPIOD3,6
 	GPIO_SetBits(GPIOD,GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_13);	//PD3,PD6 输出高
...
void GPIO_Configuration1(void)
{
  ...
  GPIO_Init(GPIOE, &GPIO_InitStructure);				 // 选择A端口 */
  }
void GPIO_Configuration2(void)
{
  ...
  GPIO_InitStructure.GPIO_Mode =  GPIO_Mode_IPU ;		   // 上拉输出
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;		 // 最高输出速率50MHz
  GPIO_Init(GPIOF, &GPIO_InitStructure);				 // 选择A端口 */
  }
/////////////////////////////////表格//////////////////////////////////
void Show_biaoge(void)
{
	  Draw_Rectangle((u16)15,(u16)127,(u16)20,(u16)100,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)31,(u16)31,(u16)20,(u16)100,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)47,(u16)47,(u16)20,(u16)100,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)63,(u16)63,(u16)20,(u16)100,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)79,(u16)79,(u16)20,(u16)100,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)95,(u16)95,(u16)20,(u16)100,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)111,(u16)111,(u16)20,(u16)100,0x01,0xFF,0xFF);
	  Draw_Rectangle((u16)15,(u16)127,(u16)30,(u16)30,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)15,(u16)127,(u16)40,(u16)40,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)15,(u16)127,(u16)50,(u16)50,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)15,(u16)127,(u16)60,(u16)60,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)15,(u16)127,(u16)70,(u16)70,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)15,(u16)127,(u16)80,(u16)80,0x01,0xFF,0xFF);
		Draw_Rectangle((u16)15,(u16)127,(u16)90,(u16)90,0x01,0xFF,0xFF);
	
	  OLED_ShowNum((u16)5,(u16)17,8,1,8,0xffff);
		OLED_ShowNum((u16)0,(u16)27,10,2,8,0xffff);
		OLED_ShowNum((u16)0,(u16)37,12,2,8,0xffff);
		OLED_ShowNum((u16)0,(u16)47,14,2,8,0xffff);
		OLED_ShowNum((u16)0,(u16)57,16,2,8,0xffff);
		OLED_ShowNum((u16)0,(u16)67,18,2,8,0xffff);
		OLED_ShowNum((u16)0,(u16)77,20,2,8,0xffff);
		OLED_ShowNum((u16)0,(u16)87,22,2,8,0xffff);
		OLED_ShowNum((u16)0,(u16)97,24,2,8,0xffff);
		

    display_char((u16)15,(u16)10, 'M', 10, 0xffff);
		display_char((u16)20,(u16)10, 'o', 10, 0xffff);
		display_char((u16)25,(u16)10, 'n', 10, 0xffff);
		display_char((u16)31,(u16)10, 'T', 10, 0xffff);
		display_char((u16)36,(u16)10, 'u', 10, 0xffff);
		display_char((u16)41,(u16)10, 'e', 10, 0xffff);
		display_char((u16)47,(u16)10, 'W', 10, 0xffff);
		display_char((u16)52,(u16)10, 'e', 10, 0xffff);
		display_char((u16)57,(u16)10, 'n', 10, 0xffff);
		display_char((u16)63,(u16)10, 'T', 10, 0xffff);
		display_char((u16)68,(u16)10, 'h', 10, 0xffff);
		display_char((u16)73,(u16)10, 'u', 10, 0xffff);
		display_char((u16)79,(u16)10, 'F', 10, 0xffff);
		display_char((u16)84,(u16)10, 'r', 10, 0xffff);
		display_char((u16)89,(u16)10, 'i', 10, 0xffff);
		display_char((u16)95,(u16)10, 'S', 10, 0xffff);
		display_char((u16)100,(u16)10, 'a', 10, 0xffff);
		display_char((u16)105,(u16)10, 't', 10, 0xffff);
	  display_char((u16)111,(u16)10, 'S', 10, 0xffff);
	  display_char((u16)116,(u16)10, 'u', 10, 0xffff);
		display_char((u16)121,(u16)10, 'n', 10, 0xffff);

}	
void beijing()
{
	        Show_64k_Pattern(gImage_zhuangshi,0x00,0x7F,0x4B,0x7F);
				  display_Chinese1616(0x11 , 0x20, 15, 0x51d);
					display_Chinese1616(0x21 , 0x30, 16, 0x51a);
					display_Chinese1616(0x31 , 0x40, 17, 0x517);
					display_Chinese1616(0x41 , 0x50, 18, 0x514);
					display_Chinese1616(0x51 , 0x60, 19, 0x511);
					display_Chinese1616(0x61 , 0x70, 20, 0x50e);
}
void kaiji(void)
{
	Fill_RAM(0x00,0x00);
